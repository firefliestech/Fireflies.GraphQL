...
internal class FederationClient {
    ...
    public async Task<FederationSchema> FetchSchema() {
        var stringContent = new StringContent(FederationQueryBuilder.BuildQuery(FederationQueryBuilder.SchemaQuery, null, OperationType.Query, "FederatedIntrospectionQuery", null));
